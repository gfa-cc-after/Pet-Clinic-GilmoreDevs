...
class UserControllerTest {
    ...
    void shouldReturnPasswordIsNotPresentWhenPasswordIsNotPResent() throws Exception {
        ...
        String content = """
                ...
                """;
        this.mockMvc.perform(post("/register").contentType(MediaType.APPLICATION_JSON).content(content)).andExpectAll(status().isBadRequest(), jsonPath("$.password", is("Password should be added")));
    }
    ...
    void shouldReturnPasswordIsNotLongEnoughWhenPasswordIsShort() throws Exception {
        ...
        String content = """
                ...
                """;
        this.mockMvc.perform(post("/register").contentType(MediaType.APPLICATION_JSON).content(content)).andExpectAll(status().isBadRequest(), jsonPath("$.password", is("Invalid password: must be at least 8 characters long")));
    }
    ...
    void shouldReturnPasswordContainsNoDigitsIfItContainsNoDigits() throws Exception {
        ...
        String content = """
                ...
                """;
        this.mockMvc.perform(post("/register").contentType(MediaType.APPLICATION_JSON).content(content)).andExpectAll(status().isBadRequest(), jsonPath("$.password", is("Invalid password: must contain at least one digit")));
    }
    ...
    void shouldReturnPasswordContainsNoUpperCaseIfPasswordContainsNoUppercase() throws Exception {
        ...
        String content = """
                ...
                """;
        this.mockMvc.perform(post("/register").contentType(MediaType.APPLICATION_JSON).content(content)).andExpectAll(status().isBadRequest(), jsonPath("$.password", is("Invalid password: must contain at least one uppercase letter")));
    }
    ...
    void shouldReturnPasswordContainsNoLowerCaseIfPasswordContainsNoLowercase() throws Exception {
        ...
        String content = """
                ...
                """;
        this.mockMvc.perform(post("/register").contentType(MediaType.APPLICATION_JSON).content(content)).andExpectAll(status().isBadRequest(), jsonPath("$.password", is("Invalid password: must contain at least one lowercase letter")));
    }
    ...
    void shouldReturnPasswordContainsWhiteSpaceIfContainsWhiteSpace() throws Exception {
        ...
        String content = """
                ...
                """;
        this.mockMvc.perform(post("/register").contentType(MediaType.APPLICATION_JSON).content(content)).andExpectAll(status().isBadRequest(), jsonPath("$.password", is("Invalid password: must not contain whitespace")));
    }
    ...
    void shouldReturnEmailIsInvalidWhenEmailIsInvalid() throws Exception {
        ...
        String content = """
                ...
                """;
        this.mockMvc.perform(post("/register").contentType(MediaType.APPLICATION_JSON).content(content)).andExpectAll(status().isBadRequest(), jsonPath("$.email", is("must be a well-formed email address")));
    }
